...
public class TelaLoginPF extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_tela_login_pf);
        ...
        Button buttonInicLogin = findViewById(R.id.BotaoLoginIni);
        buttonInicLogin.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TelaLoginPF.this, PerfilTeste.class);
